...
//     console.log(order)
//     try {
//       const response = await axios.get(`${url}/ApproveOrDeclinePost`,{
//         params: {
//           postId: order?.id,
//               statusId: 1,
//         },
...
//             <h1 className="font-bold px-4 text-4xl mt-2 mb-3">Pending Posts</h1>
//         <h4 className="px-4">
//           Dashboard / <span className="text-[#ED2024]">Pending Posts</span>
//         </h4>
...
//                     <button className="p-1 rounded-md my-1 bg-green-500" onClick={()=>handleApprove(row)}>
//                       <DoneIcon sx={{fontSize:"1.5rem",color:"white"}} />
//                       </button>

//                       </TableCell>
//                     <TableCell align="left">

//                       <button className="p-1 rounded-md my-1 bg-[#ED2024]" onClick={()=>handleReject(row)}>
...
// <VisibilityIcon sx={{fontSize:"2rem",color:"white"}}/>
