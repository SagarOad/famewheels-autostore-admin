...
console.log("data===>",images)
  ...
  return (
    <div >
      <h1 className='card-title'>{post?.makeName} {post?.modelName} {post?.yearName}</h1>
...
<span className='fw-600'> {post?.city_name} </span></p>
...
<p className='card-title mb-1 txt-danger'>{post?.registered_in}</p>
...
<p className='card-title mb-1 txt-danger'>{post?.vehicle_colour}</p>
<p className='card-title mb-1 txt-danger'>{post?.engine_capacity}</p>
<p className='card-title mb-1 txt-danger'>{post?.makeName}</p>
<p className='card-title mb-1 txt-danger'>{post?.vehicle_condition}</p>

</Col>
</Row>

<h1 className='card-title'>Description</h1>
<p className='card-title fw-600 mt-2 txt-dark d-flex gap-2 align-items-center'> {post?.description}</p>
