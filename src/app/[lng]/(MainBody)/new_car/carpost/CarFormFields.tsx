...
import { NewProjectInitialValue } from "@/Data/Application/Project";
...
export const NewCarFormFields = () => {
  ...
  const [valvesPerCylinder, setValvesPerCylinder] = useState< number | undefined>();
          ...
          <FormGroup>
            ...
            >
              {seats.map((seat,index) => (
                <option key={index} value={seat.value}>{seat.title}</option>
              ))}
           </Input>
...
{featureSelection.map((feature,index)=>(
  ...
  <option key={index} value={feature.value}>{feature.title}</option>
  ))
}
           </Input>
        ...
        <Col lg="3" md="6">
          <FormGroup>
            ...
            required
              ...
              type="select"
              className="form-control form-select"
              onChange={(e:any)=>setDriverSeatBeltWarning(e.target.value)}
        ...
        <Col lg="3" md="6">
          <FormGroup>
            ...
            required
              ...
              type="select"
              className="form-control form-select"
              onChange={(e:any)=>setDownHillAssistControl(e.target.value)}
        ...
        <Col lg="3" md="6">
          <FormGroup>
            ...
            required
              ...
              type="select"
              className="form-control form-select"
              onChange={(e:any)=>setPassengerSeatBeltWarning(e.target.value)}
        ...
        <Col lg="3" md="6">
          <FormGroup>
            ...
            required
              ...
              type="select"
              className="form-control form-select"
              onChange={(e:any)=>setHillStartAssistControl(e.target.value)}
        ...
        <Col lg="3" md="6">
          <FormGroup>
            ...
            required
              ...
              type="select"
              className="form-control form-select"
              onChange={(e:any)=>setVehicleStabilityControl(e.target.value)}
        ...
        <Col lg="3" md="6">
          <FormGroup>
            ...
            required
              ...
              type="select"
              className="form-control form-select"
              onChange={(e:any)=>setAntiLockBrakingSystem(e.target.value)}
        ...
        <Col lg="3" md="6">
          <FormGroup>
            ...
            required
              ...
              type="select"
              className="form-control form-select"
              onChange={(e:any)=>setAutonomousEmergencyBraking(e.target.value)}
  ...
  <Col lg="3" md="6">
    <FormGroup>
      ...
      required
        ...
        type="select"
        className="form-control form-select"
        onChange={(e:any)=>setRearSeatEntertainment(e.target.value)}
